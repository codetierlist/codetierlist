    ...
    return (
        <>
            ...
            <Container component="main" className="m-t-xxxl">
                ...
                <Title3 block className="p-t-xl p-b-m">
                    FAQ
                </Title3>
                ...
                <Accordion multiple className={styles.accordion}>
                    <AccordionItem value="faq1" className={styles.accordionItem}>
                        ...
                        <AccordionPanel className={styles.accordionPanel}>
                            <p>
                                Codetierlist to encourage you to start early and to test
                                often. We’re hoping that being able to compare your code
                                and tests with others will help motivate you to build good
                                tests and will provide some feedback on how effective your
                                testing is.
                            </p>
                        </AccordionPanel>
                    </AccordionItem>
